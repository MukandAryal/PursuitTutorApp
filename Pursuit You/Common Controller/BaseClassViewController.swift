...
//        gradientLayer.colors = [UIColor(red: 16/254, green: 57/254, blue: 136/254, alpha: 1.0), UIColor(red: 60/254, green: 81/254, blue: 136/254, alpha: 1.0)] // start color and end color
...
//       self.navigationController!.navigationBar.setBackgroundImage(image, for: UIBarMetrics.default)
        ...
        if let navigationBar = self.navigationController?.navigationBar {
            ...
            gradient.colors = [UIColor.white, UIColor.white]
...
extension CAGradientLayer {
    ...
    enum Point {
        ...
        var point: CGPoint {
            ...
            case .topCenter: return CGPoint(x: 0, y: 1)
            case .bottomCenter: return CGPoint(x: 0, y: 1)
