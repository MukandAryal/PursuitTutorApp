...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = UIColor.init(red: 57/255.0, green: 111/255.0, blue: 171/255.0, alpha: 1.0)
        self.imageView.layer.borderWidth = 5.0
        self.imageView.layer.borderColor =  UIColor.init(red: 217/255.0, green: 217/255.0, blue: 214/255.0, alpha: 1.0).cgColor
        self.imageView.layer.cornerRadius = 35
        self.insets = UIEdgeInsets.init(top: -65, left: 0, bottom: 0, right: 0)
